...
<title>WOW Car Rental Port | Vehicle Details</title>
<!--Bootstrap -->
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
		  ...
		  <h1>$<?php echo htmlentities($result->PricePerDay) * 5;?> </h1> Total invoice amount
        </div>
      </div>
    </div>
    <div class="row">
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="fromdate" value="05/05/2021" placeholder="From Date(dd/mm/yyyy)" required>
            </div>
            <div class="form-group">
				<p>Please enter end date:</p>
              <input type="text" class="form-control" name="todate" value="05/10/2021" placeholder="To Date(dd/mm/yyyy)" required>
            </div>
			<div class="form-group">
				<p>Please enter start location:</p>
              <input type="text" class="form-control" name="Start_loc" value="New York" placeholder="Enter Start Location" required>
            </div>
			<div class="form-group">
				<p>Please enter end location:</p>
              <input type="text" class="form-control" name="End_loc" value="New Jersey" placeholder="Enter End Location" required>
            </div>
			<div class="form-group">
				<p>Please enter discount code:</p>
              <input type="text" class="form-control" name="Coupon" value="DISCOUNT1" placeholder="Enter Coupon Code" required>
            </div>
            <div class="form-group">
          ...
          <?php if($_SESSION['login'])
			  ...
			  <div class="form-group">
				<h5>Total invoice amount has been calculated above</h5>
				</div>
              <?php } else { ?>
